...
import { useFiltersStore, useAuthStore } from "@/app/providers/ZustandStore";
...
export const ListingsPage: React.FC = () => {
  ...
  if (isError) return (
    <div className="p-8">
      ...
      <button onClick={() => refetch()} className="px-3 py-2 border rounded">Retry</button>
    </div>
  );
            ...
            <>
              ...
              {isFetchingNextPage && (
                <div className="flex justify-center items-center py-8">
                  ...
                  <span className="ml-3 text-gray-600">Loading more listings...</span>
                </div>
              )}
